 ...
 */
package org.vision.eventplugin.app;
...
import org.vision.common.logsfilter.IPluginEventListener;
...
public class PluginLauncher {
    ...
    public static void main(String[] args) {
        String path = "/Users/vision/sourcecode/eventplugin/build/plugins/plugin-mongodb-1.0.0.zip";
        ...
        eventListeners.forEach(listener -> {
            listener.setDBConfig("eventlog|vision|123456");
        });
